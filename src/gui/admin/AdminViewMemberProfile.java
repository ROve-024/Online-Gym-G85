/*
 * Created by JFormDesigner on Sat May 08 21:47:36 CST 2021
 */
...
public class AdminViewMemberProfile extends JFrame {
    ...
    public static void run(){
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    AdminViewMemberProfile frame = new AdminViewMemberProfile();
                    frame.init();
    ...
    private void init(){
        ...
        this.gender.setText(LoginBuffer.dataIsEmpty(clientData.getSex()));
