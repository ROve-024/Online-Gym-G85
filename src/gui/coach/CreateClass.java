...
public class CreateClass extends JFrame {
    ...
    private void finishButtonActionPerformed(ActionEvent e) {
        ...
        ClassFunction.createNewClassInfo(classData);
        List<ClassData> list;
        list = ClassFunction.getWholeClass();
        LessonBuffer.setBuffer(String.valueOf(ClassFunction.maxClassID(list)));
        classData.setName(LessonBuffer.toEmpty(this.className.getText()));
        classData.setCoachID(UserBuffer.getBuffer());
    ...
    private void initComponents() {
        ...
        //======== body ========
        {
            ...
            body.add(label6);
            label6.setBounds(35, 460, 210, label6.getPreferredSize().height);
    ...
    private void init() {
        ...
        this.classDetail.setText("");
        this.classCategory.setText("");
        this.classVedio.setText(LessonBuffer.dataIsEmpty(""));
        this.classFile.setText(LessonBuffer.dataIsEmpty(""));
        this.needVIP.setSelectedItem(LessonBuffer.dataIsEmpty("0"));
